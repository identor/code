...
public class Intermission1SlickBasicGame extends BasicGame{
    ...
    public void init(GameContainer gc)
        ...
        land.AddComponent( new ImageRenderComponent("PlaneRender", new Image("/res/land.jpg")) );
 
        plane = new Entity("plane");
        plane.AddComponent( new ImageRenderComponent("PlaneRender", new Image("/res/plane.png")) );
